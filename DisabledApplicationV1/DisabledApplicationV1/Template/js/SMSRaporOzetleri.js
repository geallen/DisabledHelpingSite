...
var table1 = $("#smsraportSumTable").DataTable({
    destroy: true,
    columns: [
      { "width": "50%" },
      { "width": "25%" },
    ...
    buttons: [
        {
            extend: 'excelHtml5',
            filename: window.localization.SumSmsExcel
        }
    ],
...
$.ajax({
    type: "POST",
    url: "/SMS/ShowSmsSumReportsForAllServers",
    data: {
        serverId: -1,
    ...
    .done(function (result) {
        ...
        for (var i = 0; i < reports.length; i++) {
            ...
            table1.row.add(trEl);
            totalreceiverNumber = totalreceiverNumber + reports[i][1];
        }
        table1.draw();
