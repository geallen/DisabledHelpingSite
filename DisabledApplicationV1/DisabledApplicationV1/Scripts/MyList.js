$(document).ready(function () {
  ...
  .done(function (result) {
    ...
    var reports = " reports - ";
    var helps = " helps";
    var removeList = "Remove This From My List"
    $('#roww1').empty();
      ...
      for (var i = 0; i < result.length; i++) {
        ...
        '<div class="box box-widget" style="border:none; position: relative;     margin-bottom: 20px;" >' +
          ...
          '<span class="pull-right text-muted" style="float: right!important; color:#777;">' +
           '<button type="button" title="' + removeList + '" id="removeListButton' + i + '"' + 'class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModal" data-postId=' + result[i][0] + ' style="background:white; color:#444; margin-left: 5px; margin-bottom: 5px; border-color:#ddd;" onclick="removeMyList(' + result[i][0] + "," + userId2 + ",myid" + i + ')">' +
          '<i class="fa fa-minus-square" style="display: inline-block; font: normal normal normal 18px FontAwesome; color:deepskyblue; text-rendering: auto;    -webkit-font-smoothing: antialiased;"></i></button>' + '</span>' +
